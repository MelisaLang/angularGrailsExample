describe('Document Controllers: ', function() {
    ...
    beforeEach(module('angularDocumentViewer.document.controllers'));

    describe('ShowCtrl: ', function() {
        var ctrl, scope;

        beforeEach(module(function($provide) {
            $provide.value('document', item);
        }));
        ...
        it('should have the document on the scope', function() {
            expect(ctrl.document).toEqual(item);
        });
    });
    ...
    describe('ListCtrl: ', function() {
        ...
        beforeEach(module(function($provide) {
            ...
            $provide.value('DocumentResource', mockCrudService);
            $provide.value('documentList', items);
        ...
        it('should have the documentList and default values set on the scope', function() {
            expect(ctrl.pageSize).toEqual(PAGE_SIZE);
            expect(ctrl.documentList).toEqual(items);
        ...
        it('reload should reset page', function() {
            ...
            expect(ctrl.page).toEqual(1);
            expect(ctrl.documentList).toEqual(items2);
        });
